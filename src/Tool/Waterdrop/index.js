...
function initComposer() {
    ...
    /** 后处理 - 屏幕闪动 **/
    console.log('没有吗？', THREE.GlitchPass);
...
function initAllTexturesAndImgs() {
    ...
    loader.load(
        "https://isluo.com/work/water/libs/imgs/lightray_red.jpg",
        function (texture) {
    ...
    loader.load(
        "https://isluo.com/work/water/libs/imgs/001_electric.jpg",
        function (texture) {
    ...
    cubeLoader.load(
        [
            "https://isluo.com/work/water/libs/imgs/skybox/posx.jpg",
            "https://isluo.com/work/water/libs/imgs/skybox/negx.jpg",
            "https://isluo.com/work/water/libs/imgs/skybox/posy.jpg",
            "https://isluo.com/work/water/libs/imgs/skybox/negy.jpg",
            "https://isluo.com/work/water/libs/imgs/skybox/posz.jpg",
            "https://isluo.com/work/water/libs/imgs/skybox/negz.jpg",
        ],
        function (texture) {
...
function initNames() {
    ...
    for (let i = 0; i < users.length; i++) {
        ...
        str += `<li><div>${n}</div>${users[i].w ? `<div class="w">(${users[i].w})</div>` : ""
...
/** 音频控制相关 **/
const musics = [
    { url: "https://isluo.com/work/water/libs/music/0.mp3", title: "Fearless" },
    { url: "https://isluo.com/work/water/libs/music/1.mp3", title: "Qiu Mansion" },
];
